            ...
            <div className='flex justify-between'>
                ...
                <div>
                    <div className='flex justify-center mb-4 lg:mb-8 gap-1'>
                        <GlobalLink href="https://www.instagram.com/jagranreviews/" target="_blank" className="flex items-center text-white font-semibold rounded-full gap-1 py-0 lg:py-2 px-4 bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045]">
