          ...
          <ol role="list" className="w-full flex items-center space-x-2">
            ...
            <li>
              <div className="flex items-center">
                ...
                <GlobalLink
                  href={`/${breadcrumb?.category?.category_slug}`}
                  className="ml-2 uppercase text-[9px] lg:text-xs font-medium text-gray-500 hover:text-red-500"
                >
            ...
            {/* <li>
              <div className="flex items-center">
                ...
                <GlobalLink
                  href={`/${breadcrumb?.category?.category_slug}/${breadcrumb?.subcategory?.category_slug}`}
                  className="ml-2 uppercase text-[9px] lg:text-xs font-medium text-gray-500 hover:text-red-500"
                >
                  {breadcrumb?.subcategory?.category_name}
                </GlobalLink>
              </div>
            </li> */}
          </ol>
